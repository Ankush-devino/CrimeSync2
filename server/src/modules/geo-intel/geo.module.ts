...
const DEFAULT_GEO_EVENTS: GeoEvent[] = [
  ...
  // CASE-2026-010: 3 pins: Bengaluru (victim) → Mewat/Nuh (Rohit's tower cluster) → Jaipur (ATM cashout)
  {
    id: "GEO-EVT-013",
    case_id: "CASE-2026-010",
    case_title: "Operation Task Trap: Fake YouTube Like Job Scam",
    event_type: "CRIME_SCENE",
    title: "Bengaluru (Victim) — WhatsApp Hook & UPI Fraud",
    description: "Victim Pooja (21, Student) received WhatsApp scam bait from spoofed number +1-202-555-0143 and transferred ₹5,00,000 via SBI UPI.",
    latitude: 12.9352,
    longitude: 77.6245,
    location_name: "Koramangala 5th Block, Bengaluru",
    city: "Bengaluru",
    state: "Karnataka",
    severity: "HIGH",
    timestamp: "2026-09-12T10:00:00.000Z",
    suspect_id: "SUS-911",
    suspect_name: "Pooja (Victim Reporting)",
    confidence: 99.0,
    evidence_hash: "0x8899aabbccddeeff00112233445566778899aabbccddeeff0011223344556677",
    radius_meters: 350,
  },
  {
    id: "GEO-EVT-014",
    ...
    case_title: "Operation Task Trap: Fake YouTube Like Job Scam",
    event_type: "RAID_TARGET",
    title: "Mewat/Nuh (Rohit's Tower Cluster) — Telecom Triangulation",
    description: "Burner SIM (+91-96500-71028) & Handset IMEI 867381024917624 triangulated within 300m radius of Rohit Verma in Nuh/Mewat during 48h fraud window.",
    latitude: 28.1070,
    longitude: 76.9980,
    location_name: "Tauru Road, Nuh Cyber Hub, Mewat",
    city: "New Delhi",
    state: "Haryana",
    severity: "CRITICAL",
    timestamp: "2026-09-13T13:00:00.000Z",
    suspect_id: "SUS-914",
    suspect_name: "Rohit Verma (Kingpin)",
    confidence: 94.2,
    evidence_hash: "0x7788990011223344556677889900112233445566778899001122334455667788",
    radius_meters: 500,
  },
  {
    id: "GEO-EVT-015",
    ...
    title: "Jaipur (ATM Cashout) — ₹1,80,000 Withdrawn & CCTV",
    description: "Mule Rahul Sharma withdrew ₹1,80,000 cash from ICICI ATM within 30 minutes. CCTV camera JPR-CCTV-MI-04 captured facial verification.",
    latitude: 26.9124,
    longitude: 75.7873,
    location_name: "ICICI Bank ATM, MI Road, Jaipur",
    city: "Jaipur",
    state: "Rajasthan",
    severity: "CRITICAL",
    timestamp: "2026-09-13T12:15:00.000Z",
    suspect_id: "SUS-913",
    suspect_name: "Rahul Sharma (Mule 2)",
    confidence: 96.4,
    evidence_hash: "0x3344556677889900112233445566778899001122334455667788990011223344",
    radius_meters: 250,
  },
  {
    ...
    case_title: "Operation Parcel Trap: FedEx Digital Arrest Scam",
    event_type: "CRIME_SCENE",
    title: "Hyderabad (Victim Node) — Banjara Hills Residence",
    description: "Dr. Aruna Rao residence; location of the 6-hour coercive Skype digital arrest call originating from spoofed FedEx IVR.",
    latitude: 17.4156,
    longitude: 78.4350,
    location_name: "Banjara Hills Road No. 12, Hyderabad",
    city: "Hyderabad",
    state: "Telangana",
    severity: "HIGH",
    timestamp: "2026-09-14T09:15:00.000Z",
    suspect_id: "VIC-011",
    suspect_name: "Dr. Aruna Rao (Victim)",
    confidence: 99.0,
    evidence_hash: "0x9a10283749102837491028374910283749102837491028374910283749102837",
    radius_meters: 100,
  },
  {
    id: "GEO-EVT-017",
    ...
    case_title: "Operation Parcel Trap: FedEx Digital Arrest Scam",
    event_type: "HAWALA_HUB",
    title: "Mumbai (VoIP Proxy Ingress) — BKC Data Center",
    description: "Colocation data center hosting the unauthenticated Asterisk SIP trunk spoofing FedEx landlines (+91-80-4920-8812).",
    latitude: 19.0760,
    longitude: 72.8777,
    ...
    suspect_id: "SUS-916",
    suspect_name: "Asterisk SIP Gateway (IP: 103.212.44.89)",
    confidence: 92.5,
    evidence_hash: "0x5519283749102938471029384710293847102938471029384710293847102938",
    radius_meters: 300,
  },
  {
    id: "GEO-EVT-018",
    ...
    case_title: "Operation Parcel Trap: FedEx Digital Arrest Scam",
    event_type: "CCTV_DETECTION",
    title: "Surat (Cash-Out Node) — Ring Road ICICI ATM",
    description: "ICICI Bank ATM Kiosk where mule runner Mukesh Solanki executed 9 ATM withdrawals totaling ₹3,60,000 in cash (97.1% face match).",
    latitude: 21.1959,
    longitude: 72.8302,
    location_name: "Ring Road Textile Market, Surat",
    city: "Surat",
    state: "Gujarat",
    severity: "CRITICAL",
    timestamp: "2026-09-14T13:50:00.000Z",
    suspect_id: "SUS-917",
    suspect_name: "Mukesh Solanki (Mule Runner)",
    confidence: 97.1,
    evidence_hash: "0x6610293847592019384758192039485710293847592019384758192039485710",
    radius_meters: 200,
  },
  {
    id: "GEO-EVT-019",
    ...
    case_title: "Operation Parcel Trap: FedEx Digital Arrest Scam",
    event_type: "RAID_TARGET",
    title: "Ahmedabad (Mule 1 Banking Node) — Ashram Road HDFC",
    description: "HDFC Bank branch where ₹6,00,000 transferred by victim was successfully frozen under Section 106 BNSS.",
    latitude: 23.0225,
    longitude: 72.5714,
    location_name: "Ashram Road Commercial Area, Ahmedabad",
    city: "Ahmedabad",
    state: "Gujarat",
    severity: "HIGH",
    timestamp: "2026-09-14T11:30:00.000Z",
    suspect_id: "SUS-918",
    suspect_name: "Dinesh Patel (Mule Account Holder)",
    confidence: 95.0,
    evidence_hash: "0x7719283749102938471029384710293847102938471029384710293847102938",
    radius_meters: 250,
  },
  {
    ...
    case_title: "Operation Parcel Trap: FedEx Digital Arrest Scam",
    event_type: "RAID_TARGET",
    title: "Bharatpur / Deeg (Kingpin Hub) — Fake Police Studio",
    description: "Rented residential safehouse operating fake police station set; triangulated via BTS towers & AI voiceprint match to Vikram Gurjar.",
    latitude: 27.2152,
    longitude: 77.4930,
    location_name: "Deeg Road Cyber Belt, Bharatpur",
    city: "Bharatpur",
    state: "Rajasthan",
    severity: "CRITICAL",
    timestamp: "2026-09-14T15:45:00.000Z",
    suspect_id: "SUS-919",
    suspect_name: "Vikram Gurjar (Alias: DCP Rathore)",
    confidence: 96.8,
    evidence_hash: "0x8819203948571029384759201938475819203948571029384759201938475819",
    radius_meters: 500,
  },
];
...
const DEFAULT_SUSPECT_MOVEMENTS: SuspectMovement[] = [
  ...
  // 7. CASE-2026-010: JAIPUR / MEWAT - Rahul Sharma & Rohit Verma
  {
    id: "TRK-010",
    suspect_id: "SUS-913",
    suspect_name: "Rahul Sharma (Mule Operative)",
    case_id: "CASE-2026-010",
    case_title: "Operation Task Trap: Fake YouTube Like Job Scam",
    city: "Jaipur",
    color: "#ef4444",
    ...
    last_known_location: "ICICI Bank ATM, MI Road, Jaipur",
    waypoints: [
      {
        sequence: 1,
        latitude: 26.8528,
        longitude: 75.8242,
        location_name: "ICICI Bank Malviya Nagar Branch, Jaipur",
        timestamp: "11:45 AM",
        speed_kmh: 0,
        activity: "Mule Account Verification & Balance Check",
        activity_type: "FINANCIAL_PROBING",
        forensic_narrative: "Suspect Rahul Sharma checked account balance for A/C ****8841 via micro-ATM terminal immediately upon ₹2,00,000 UPI credit from victim Pooja.",
        tower_id: "JPR-BTS-1044",
        cell_id: "CELL-10441",
        signal_strength_dbm: -58,
        transit_mode: "Stationary (Commercial Bank Annex)",
        telecom_trace: {
          imei: "869102837482910",
          imsi: "404101928374612",
          carrier: "Airtel 5G",
          band: "Band 3 (1800 MHz)",
        },
        legal_sections: ["Section 318(4) BNS", "Section 66D IT Act"],
      },
      {
        sequence: 2,
        latitude: 26.8834,
        longitude: 75.8055,
        location_name: "Tonk Road / Ajmeri Gate Corridor, Jaipur",
        timestamp: "12:05 PM",
        speed_kmh: 38,
        activity: "Transit to Target Cash-out ATM",
        activity_type: "IN_TRANSIT",
        forensic_narrative: "Suspect monitored traveling north along Tonk Road on two-wheeler (RJ-14-EA-9912) towards commercial banking zone.",
        tower_id: "JPR-BTS-2209",
        cell_id: "CELL-22093",
        signal_strength_dbm: -68,
        transit_mode: "Two-Wheeler Transit",
        vehicle_plate: "RJ-14-EA-9912",
        telecom_trace: {
          imei: "869102837482910",
          imsi: "404101928374612",
          carrier: "Airtel 5G",
      ...
      },
      {
        ...
        timestamp: "12:15 PM",
        speed_kmh: 0,
        activity: "₹1,80,000 Cash Withdrawal & CCTV Capture",
        activity_type: "CASH_WITHDRAWAL",
        forensic_narrative: "Rahul Sharma executed 9 consecutive ATM withdrawals of ₹20,000 totaling ₹1,80,000. Retained ₹20,000 mule fee. Clear facial capture logged by camera JPR-CCTV-MI-04.",
        tower_id: "JPR-BTS-3310",
        cell_id: "CELL-33102",
        signal_strength_dbm: -49,
        transit_mode: "Stationary (ATM Kiosk)",
        cctv_corroboration: {
          camera_code: "JPR-CCTV-MI-04",
          face_match_confidence: 96.4,
          frame_evidence_hash: "0x3344556677889900112233445566778899001122334455667788990011223344",
        },
        telecom_trace: {
          imei: "869102837482910",
          imsi: "404101928374612",
      ...
      },
      {
        ...
        latitude: 26.9196,
        longitude: 75.7880,
        location_name: "Jaipur Junction Railway Station (Platform 1)",
        timestamp: "12:40 PM",
        speed_kmh: 12,
        activity: "Evasion & Cash Courier Drop",
        activity_type: "TRANSIT_ESCAPE",
        forensic_narrative: "Suspect entered station perimeter. Handed over physical cash envelope to unknown courier prior to Delhi-bound train departure.",
        tower_id: "JPR-BTS-4091",
        cell_id: "CELL-40911",
        signal_strength_dbm: -62,
        transit_mode: "Pedestrian Transit",
        telecom_trace: {
          imei: "869102837482910",
          imsi: "404101928374612",
          carrier: "Airtel 5G",
        ...
        legal_sections: ["Section 318 BNS", "Section 65B BSA 2023"],
      },
    ],
  },
  // CASE-2026-011: SURAT - Mukesh Solanki (Mule Runner)
  {
    id: "TRK-011",
    suspect_id: "SUS-917",
    suspect_name: "Mukesh Solanki (Mule Runner)",
    ...
    last_known_location: "Surat Railway Station (Platform 2)",
    waypoints: [
      {
        sequence: 1,
        latitude: 21.1908,
        longitude: 72.8365,
        location_name: "Majura Gate Axis Bank, Surat",
        timestamp: "01:15 PM",
        speed_kmh: 0,
        activity: "Balance Verification on A/C ****9912",
        activity_type: "TRANSACTION_POINT",
        forensic_narrative: "Balance verification on A/C ****9912 immediately following ₹4L RTGS credit from victim. Connected to tower SRT-BTS-MJ01.",
        tower_id: "SRT-BTS-MJ01",
        cell_id: "CELL-SRT-01",
        signal_strength_dbm: -68,
        transit_mode: "Two-Wheeler",
        telecom_trace: {
          imei: "864920194829104",
          imsi: "404119283746199",
          carrier: "Jio 5G",
          band: "n78 (3500 MHz)",
        },
        legal_sections: ["Section 318(4) BNS", "Section 66D IT Act"],
      },
      {
        ...
        latitude: 21.1935,
        longitude: 72.8330,
        location_name: "Ring Road Flyover Corridor, Surat",
        timestamp: "01:35 PM",
        speed_kmh: 38,
        activity: "Corridor Transit on Two-Wheeler",
        activity_type: "TRANSIT_ESCAPE",
        forensic_narrative: "Transit along Textile Market corridor on two-wheeler GJ-05-KM-4421. Captured by ANPR Camera SRT-ANPR-RR-02.",
        tower_id: "SRT-BTS-RR02",
        cell_id: "CELL-SRT-02",
        signal_strength_dbm: -60,
        transit_mode: "Two-Wheeler (GJ-05-KM-4421)",
        telecom_trace: {
          imei: "864920194829104",
          imsi: "404119283746199",
          carrier: "Jio 5G",
      ...
      },
      {
        ...
        latitude: 21.1959,
        longitude: 72.8302,
        location_name: "ICICI Bank ATM, Ring Road, Surat",
        timestamp: "01:50 PM",
        speed_kmh: 0,
        activity: "ATM Cash-Out (₹3,60,000)",
        activity_type: "CRIME_EXECUTION",
        forensic_narrative: "₹3,60,000 cash withdrawn across 9 consecutive ₹40,000 transactions; ₹40,000 mule fee pocketed. 4K CCTV SRT-CCTV-RR-09 matches face vector at 97.1%.",
        tower_id: "SRT-BTS-RR03",
        cell_id: "CELL-SRT-03",
        signal_strength_dbm: -58,
        transit_mode: "ATM Kiosk",
        telecom_trace: {
          imei: "864920194829104",
          imsi: "404119283746199",
          carrier: "Jio 5G",
      ...
      },
      {
        ...
        latitude: 21.2064,
        longitude: 72.8363,
        location_name: "Surat Railway Station (Platform 2)",
        timestamp: "02:20 PM",
        speed_kmh: 10,
        activity: "Angadia Courier Cash Handover",
        activity_type: "TRANSIT_ESCAPE",
        forensic_narrative: "Physical cash envelope handed over to Angadia courier boarding Gujarat Mail train heading towards Delhi/Rajasthan belt.",
        tower_id: "SRT-BTS-ST01",
        cell_id: "CELL-SRT-04",
        signal_strength_dbm: -64,
        transit_mode: "Pedestrian Transit",
        telecom_trace: {
...
const DEFAULT_CCTV_FEEDS: CctvFeed[] = [
  ...
  // Jaipur (CASE-2026-010)
  {
    id: "CAM-JPR-01",
    camera_code: "JPR-CCTV-MI-04",
    location_name: "ICICI Bank ATM, MI Road Kiosk",
    city: "Jaipur",
    latitude: 26.9124,
    longitude: 75.7873,
    status: "ALERT_TRIGGERED",
    resolution: "4K AI Face Match",
    fov_angle: 110,
    coverage_radius_meters: 150,
    last_detection: {
      suspect_name: "Rahul Sharma (Mule 2)",
  ...
  {
    id: "CAM-BLR-03",
    camera_code: "BLR-CCTV-KOR-08",
    location_name: "Koramangala 5th Block Junction",
    city: "Bengaluru",
    latitude: 12.9352,
    longitude: 77.6245,
    status: "ONLINE",
...
const DEFAULT_POLICE_STATIONS: PoliceStation[] = [
  ...
  {
    id: "PS-JPR-01",
    name: "Jaipur Cyber Crime Police Station (MI Road)",
    division: "Jaipur Police Commissionerate",
    city: "Jaipur",
    latitude: 26.9150,
    longitude: 75.7900,
    contact: "+91-141-2740000",
...
export class GeoIntelService {
  async getHotspots(filters?: { case_id?: string; city?: string; severity?: string; event_type?: string }) {
    if (filters?.case_id && filters.case_id !== "*") {
      const inMem = inMemoryEvents.filter((e) => e.case_id === filters.case_id);
